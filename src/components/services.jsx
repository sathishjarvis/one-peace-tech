...
import dynamics from '../projects/dynamic.jpeg'
import statics from '../projects/static.png'
    ...
    <div id="services" className="text-center">
      <div className="container">
        ...
        <div className="row gap">
          {props.data
            ? props.data.map((d, i) => (
              <div key={`${d.name}-${i}`} className="col-md-4 cards">
                {" "}
            ...
            : "loading"}
          <details>
            <summary><p className="btn btn-primary"><i className="fa fa-arrow-down arrows" aria-hidden="true"></i> see more details</p></summary>
            <div className="pricing-container">
              ...
              <div className="pricing-content">
                <div className="plan-image">
                  ...
                  <div className="price">
                    <p>&#8377; 3999</p>
                    <p className="underline">for One Year</p>
                    <p>+18% GST</p>
                  </div>
